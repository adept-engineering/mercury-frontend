      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) => updateFormData("senderEntity", value)}
          >
        ...
        <div className="space-y-2">
          ...
          <Select
            value={formData.interChangeId}
            onValueChange={(value) => updateFormData("interChangeId", value)}
          >
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) => updateFormData("transactionName", value)}
          >
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              updateFormData("accepterAliasLookup", e.target.value)
            }
            placeholder="Enter version"
            className="w-full"
          />
